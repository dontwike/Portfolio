...
import { SiHibernate, SiMongodb } from "react-icons/si";
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaHtml5 className="text-7xl text-[#fc490b]" />
        </motion.div>
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaCss3Alt className="text-7xl text-[#0065f4]" />
        </motion.div>
        <motion.div
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <BiLogoTypescript className="text-7xl text-[#3178c6]" />
        </motion.div>
        <motion.div
          variants={iconVariants(5)}
          initial="initial"
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <SiHibernate className="text-7xl text-[#59666c]" />
        </motion.div>
      </motion.div>
    </div>
  );
